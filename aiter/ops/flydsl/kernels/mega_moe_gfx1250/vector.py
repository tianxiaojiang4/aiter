...
"""Vector dialect wrappers, vendored next to mega_moe TDM prims.

main dropped ``aiter.ops.flydsl.kernels.vector`` in #5303. This copy is the
pre-deletion helper used by ``tdm_prims``.
